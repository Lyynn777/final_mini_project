...
function showNotification(position) {
    ...
    const targetLat = 12.966376;  // Example supermarket latitude
    const targetLon = 77.654059;  // Example supermarket longitude
...
function askNotificationPermission() {
    if (Notification.permission === "default") {
        // Request permission if it's not yet granted or denied
        ...
        console.log("Notification permission previously denied. Please enable it in browser settings.");
    } else {
